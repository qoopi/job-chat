...
// The Left Chat Part (interaction-spec section 1), table content type only (the sole LCP content type
// for now). It takes the middle of the canvas while the
// chat docks to the 360px right rail; this is the minimal shell - a 48px header (title left, close
// right) matching the rail header, and the full insight table body. Deliberate omissions (deferred):
// deep-link URLs, breadcrumb stack, trigger-toggle close.
