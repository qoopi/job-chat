...
test("Should_NotReRenderSettledInsightCard_When_LaterTurnStreams", () => {
  ...
  const { rerender } = render(
    <MessageList messages={first} status="streaming" usedFollowups={usedFollowups} onFollowup={noop} onRetry={noop} />,
  );
  ...
  rerender(
    <MessageList messages={second} status="streaming" usedFollowups={usedFollowups} onFollowup={noop} onRetry={noop} />,
  );
