...
// 018 review-fix (should-fix S3): the salary histogram is the ONE surface that used to hardcode a `$`
...
// (strand goal: chart and source line AGREE). This renders the real component with an EUR fixture and
