...
// LCP form from it, builds the profile (e2e short-circuits the save), and confirms the profile card is
// injected into the thread.
const PROFILE_INVITE_ID = "00000000-0000-4000-8000-000000000002";

test("profile-invite -> LCP form -> profile card in thread", async ({ page }) => {
  ...
  // Clicking it opens the LCP profile form (empty state).
