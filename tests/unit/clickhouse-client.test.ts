...
// ClickHouse Cloud idles the service between sessions and its wake exceeds the client's 30s
...
describe("Should_SurviveClickHouseCloudIdleWake_When_ClientCreated (request_timeout)", () => {
  const writerEnv = {
