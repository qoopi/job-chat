...
--
-- resume_pdf is TRANSIENT PII: written by the save action, read once by the task, NULLed after
-- extraction - never long-term PII at rest. Additive + idempotent (CREATE TABLE IF NOT EXISTS).
